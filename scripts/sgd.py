...
for trial in range(1, 4):
    ...
    start = time()
    history1 = mlp1.sgd_train(x_train, y_train, 1e-1, 1000, 32, x_test, y_test)
    end = time()
    ...
    plt.xlabel('Epoch')
    plt.legend()
    plt.savefig('figures/' + str(trial) + 'lsgde-1.png')
    plt.clf()
    ...
    plt.xlabel('Epoch')
    plt.legend()
    plt.savefig('figures/' + str(trial) + 'asgde-1.png')
    plt.clf()

    mlp2 = LeakyReLUSoftmaxCCE((28, 28), 10, [16, 16, 16])

    start = time()
    history2 = mlp2.sgd_train(x_train, y_train, 1e-3, 1000, 32, x_test, y_test)
    end = time()
    ...
    plt.xlabel('Epoch')
    plt.legend()
    plt.savefig('figures/' + str(trial) + 'lsgde-3.png')
    plt.clf()
    ...
    plt.xlabel('Epoch')
    plt.legend()
    plt.savefig('figures/' + str(trial) + 'asgde-3.png')
    plt.clf()

    mlp3 = LeakyReLUSoftmaxCCE((28, 28), 10, [16, 16, 16])

    start = time()
    history3 = mlp3.sgd_train(x_train, y_train, 1e-5, 1000, 32, x_test, y_test)
    end = time()
    ...
    plt.xlabel('Epoch')
    plt.legend()
    plt.savefig('figures/' + str(trial) + 'lsgde-5.png')
    plt.clf()
    ...
    plt.xlabel('Epoch')
    plt.legend()
    plt.savefig('figures/' + str(trial) + 'asgde-5.png')
    plt.clf()

with open('output/sgd.txt', 'w') as f:
    f.write('\n'.join(lines))
