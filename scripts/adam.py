...
for trial in range(1, 4):
    ...
    start = time()
    history1 = mlp1.adam_train(x_train, y_train, 1e-1, 1000, 0.9, 0.999, 1e-8, 32, x_test, y_test)
    end = time()
    ...
    plt.xlabel('Epoch')
    plt.legend()
    plt.savefig('figures/' + str(trial) + 'ladme-1.png')
    plt.clf()
    ...
    plt.xlabel('Epoch')
    plt.legend()
    plt.savefig('figures/' + str(trial) + 'aadme-1.png')
    plt.clf()
    ...
    plt.xlabel('Epoch')
    plt.legend()
    plt.savefig('figures/' + str(trial) + 'ladme-3.png')
    plt.clf()
    ...
    plt.xlabel('Epoch')
    plt.legend()
    plt.savefig('figures/' + str(trial) + 'aadme-3.png')
    plt.clf()
    ...
    plt.xlabel('Epoch')
    plt.legend()
    plt.savefig('figures/' + str(trial) + 'ladme-5.png')
    plt.clf()
    ...
    plt.xlabel('Epoch')
    plt.legend()
    plt.savefig('figures/' + str(trial) + 'aadme-5.png')
    plt.clf()

with open('output/adam.txt', 'w') as f:
    f.write('\n'.join(lines))
