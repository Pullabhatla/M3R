...
for trial in range(1, 4):
    ...
    start = time()
    history1 = mlp1.noisy_sgd_train(x_train, y_train, 1e-2, 1000, 32, 0.55, x_test, y_test)
    end = time()
    ...
    start = time()
    history2 = mlp2.noisy_sgd_train(x_train, y_train, 1e-3, 1000, 32, 0.55, x_test, y_test)
    end = time()
    ...
    start = time()
    history3 = mlp3.noisy_sgd_train(x_train, y_train, 1e-5, 1000, 32, 0.55, x_test, y_test)
    end = time()
